    ...
    public void OnEndDrag(PointerEventData data)
    {
        if (data.button == PointerEventData.InputButton.Left)
        {
            ...
            if (newSlot != null)
            {
                ...
                if (Inventory.GetComponent<Hotbar>() == null && Inventory.GetComponent<EquipmentSystem>() == null && Inventory.GetComponent<CraftSystem>() == null && Inventory.GetComponent<Marketplace>() == null)
                {
                    //Debug.Log("Drag ending started");
                ...
                if (Inventory.GetComponent<Marketplace>() != null)
                {
                    ...
                    //Item sellItem = firstItemGameObject.GetComponent<ItemOnObject>().item;

                    playerinventory.SellItem(firstItem);
